...
3. `npm i vdom-parser routes shave-template xhr-promise-bare virtual-dom-patch-viewer`
...
### features
* Standalone, curly-free HTML files as templates.
...
* `virtual-dom`:
  ...
  - `vtree/diff.js` ln:66, added trim to skip whitespace changes
